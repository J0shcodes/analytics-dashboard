const Platform = () => {
  return (
    <div className="col-span-5 bg-white px-5 py-[1.13rem] border border-solid border-[#edf2f7] rounded-[0.875rem]">
      ...
      <div className="mt-5">
        <div>
          <div className="text-lg text-analytics-dark-4 font-semibold mb-[1.06rem]">Book Bazaar</div>
          <div className="h-3 rounded-[2.5rem] bg-analytics-grey-2">
            <div className="h-[100%] w-[50%] rounded-[2.5rem] bg-[#6160dc]"></div>
          </div>
          <div className="mt-4 mb-5 flex justify-between items-center text-lg text-analytics-grey-3">
            <p> $2,500,000</p>
            <p>+15%</p>
          </div>
        </div>
        <div>
          <div className="text-lg text-analytics-dark-4 font-semibold mb-[1.06rem]">Artisan Aisle</div>
          <div className="h-3 rounded-[2.5rem] bg-analytics-grey-2">
        ...
        <div>
          <div className="text-lg text-analytics-dark-4 font-semibold mb-[1.06rem]">Toy Troop</div>
          <div className="h-3 rounded-[2.5rem] bg-analytics-grey-2">
        ...
        <div>
          <div className="text-lg text-analytics-dark-4 font-semibold mb-[1.06rem]">XStore</div>
        </div>
      </div>
    </div>
  );
